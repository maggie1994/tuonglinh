		...
		<div class="content">
			...
			<div class="experience">
				<div class="main">
					<div class="container clearfix">
						...
						<p class="sub-tt">I have passion for website design and HTML, CSS. So I always try to learn new things to make my skill more professional.</p>
			...
			<div class="portfolio">
				<div class="main">
					<div class="container">
						<h2>Portfolio</h2>
						<p class="sub-tt">These are all projects I have done. Please take a look at each project and give me your opinion.</p>
						<div id="carousel">
					        <ul class="flip-items">
